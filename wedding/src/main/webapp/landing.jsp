...
function initMap() {
	...
	var infowindow1 = new google.maps.InfoWindow({
		  content:"Ceremony: 1615 Howard St, Omaha, NE 68102"
	});
 	// Info displayed when marker clicked
...
<div class="carousel slide justify-content-center" data-ride="carousel">
	<div class="carousel-inner">
		<div class="carousel-item active d-block d-md-none">
			<img class="img-fluid main-img-sm" src="images/engagement_sitting.jpg">
		</div>
		<div class="carousel-item active d-none d-md-block d-lg-none">
			<img class="img-fluid main-img-md" src="images/engagement_sitting.jpg">
		</div>
		<div class="carousel-item active d-none d-lg-block d-xl-none">
			<img class="img-fluid main-img-lg" src="images/engagement_sitting.jpg">
		</div>
		<div class="carousel-item active d-none d-xl-block">
			<img class="img-fluid main-img-xl" src="images/engagement_sitting.jpg">
		</div>
			<div class="container">
				<div class="carousel-caption d-block d-md-none justify-content-center">
					<!-- Name/Date BEGIN -->
					<div class="row row-loc justify-content-center" height="2rem">
						<div class="container-fluid cont-header align-items-start">
							<hr align="left" width="40%"></hr>
							<h1 class="font-tangerine-sm" align="center">Lindsey Ann + Brandon Craig</h1>
							<hr align="right" width="40%"></hr>
						</div>
						<h3 class="font-tangerine-sm align-item-end">June 8, 2019  |  Omaha, NE</h4>
					</div><!-- /.row -->
					<div class="row row-loc align-items-end justify-content-center" height="2rem">
...
<div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-7 align-items-center justify-content-center">
          ...
          <p class="lead font-osc"> We first met way back in first grade at Harvey Oaks Elementary, but that is not where our love story starts. We spent countless hours together on the school bus throughout elementary school, let's just say these are not Lindsey's favorite memories. 
          We didn't talk much when middle school started, but our paths crossed again in 8th grade. Many weekends were spent getting to know each other more at OakView Mall and AMC Theater. Brandon asked Lindsey to be his girlfriend, one very early morning on Brandon's 14th birthday. We made the transition from Middle School to High School together, where we spent the next four years attending Homecoming, Prom,
        ...
        <div class="col-md-5 align-items-center justify-content-center">
          <img class="featurette-image img-fluid land-img" src="images/FirstMet.jpg" data-holder-rendered="true">
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          ...
          <p class="lead font-osc"> After nine years together, Brandon finally popped the question on a cold night in December. The day started as usual, Lindsey went to work with plans of going to dinner that night to celebrate David's birthday. Brandon had his own plans of adding the finishing touches to the proposal that would occur later that night. 
          ...
          the birthday celebration and she is uncontrollably sobbing while standing in the bathroom. At this time Brandon is thinking "what am I getting myself into" but he is very persistent and finally gets Lindsey out of the house. When we arrived at Brandon's mom's house everything played out as normal there were normal greetings, normal conversations, then Lindsey noticed Brandon was missing and there were new Christmas lights outside. 
        ...
        <div class="col-md-5 align-items-center justify-content-center">
          <img class="featurette-image img-fluid land-img" src="images/MarryMe.jpg" data-holder-rendered="true">
        </div>
      </div>
